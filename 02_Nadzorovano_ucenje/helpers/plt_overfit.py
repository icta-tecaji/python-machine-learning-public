...
from .lab_utils_common_reg import np, plt, dlc, predict_logistic, plot_data, zscore_normalize_features
...
class overfit_example():
    ...
    def linear_regression(self):
        ...
        linear_model = make_pipeline(StandardScaler(with_mean=False), Ridge(alpha=self.lambda_, max_iter=10000))
        linear_model.fit(self.X_mapped_scaled, self.y )
        self.w = linear_model["ridge"].coef_.reshape(-1,)
        self.b = linear_model["ridge"].intercept_
